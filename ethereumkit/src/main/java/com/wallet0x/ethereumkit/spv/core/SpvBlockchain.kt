...
import com.wallet0x.ethereumkit.core.EthereumKit.SyncError
import com.wallet0x.ethereumkit.core.EthereumKit.SyncState
import com.wallet0x.ethereumkit.core.IBlockchain
import com.wallet0x.ethereumkit.core.IBlockchainListener
...
import com.wallet0x.ethereumkit.spv.net.PeerGroup
import com.wallet0x.ethereumkit.spv.net.PeerProvider
import com.wallet0x.ethereumkit.spv.net.handlers.*
import com.wallet0x.ethereumkit.spv.net.tasks.HandshakeTask
...
class SpvBlockchain(
    ...
    private val blockSyncer: com.wallet0x.ethereumkit.spv.core.BlockSyncer,
    private val accountStateSyncer: com.wallet0x.ethereumkit.spv.core.AccountStateSyncer,
    ...
    com.wallet0x.ethereumkit.spv.core.BlockSyncer.Listener, com.wallet0x.ethereumkit.spv.core.AccountStateSyncer.Listener, TransactionSender.Listener {
    ...
    companion object {
        fun getInstance(storage: ISpvStorage, transactionBuilder: TransactionBuilder, rpcApiProvider: IRpcApiProvider, network: INetwork, address: Address, nodeKey: ECKey): SpvBlockchain {
            ...
            val blockSyncer =
                com.wallet0x.ethereumkit.spv.core.BlockSyncer(storage, blockHelper, blockValidator)
            val accountStateSyncer =
                com.wallet0x.ethereumkit.spv.core.AccountStateSyncer(storage, address)
