...
import com.wallet0x.ethereumkit.api.core.*
import com.wallet0x.ethereumkit.api.jsonrpc.JsonRpc
import com.wallet0x.ethereumkit.api.jsonrpc.models.RpcBlock
import com.wallet0x.ethereumkit.api.jsonrpc.models.RpcTransaction
import com.wallet0x.ethereumkit.api.jsonrpc.models.RpcTransactionReceipt
import com.wallet0x.ethereumkit.api.models.AccountState
import com.wallet0x.ethereumkit.api.models.EthereumKitState
import com.wallet0x.ethereumkit.api.storage.ApiStorage
import com.wallet0x.ethereumkit.core.signer.Signer
import com.wallet0x.ethereumkit.core.storage.Eip20Storage
import com.wallet0x.ethereumkit.core.storage.TransactionStorage
import com.wallet0x.ethereumkit.core.storage.TransactionSyncerStateStorage
import com.wallet0x.ethereumkit.crypto.CryptoUtils
import com.wallet0x.ethereumkit.crypto.InternalBouncyCastleProvider
import com.wallet0x.ethereumkit.decorations.DecorationManager
import com.wallet0x.ethereumkit.decorations.EthereumDecorator
import com.wallet0x.ethereumkit.decorations.TransactionDecoration
import com.wallet0x.ethereumkit.models.*
import com.wallet0x.ethereumkit.network.*
import com.wallet0x.ethereumkit.transactionsyncers.EthereumTransactionSyncer
import com.wallet0x.ethereumkit.transactionsyncers.InternalTransactionSyncer
import com.wallet0x.ethereumkit.transactionsyncers.TransactionSyncManager
        ...
        fun getInstance(
            ...
            val syncer: IRpcSyncer = when (rpcSource) {
                ...
                is RpcSource.Http -> {
                    ...
                    com.wallet0x.ethereumkit.api.core.ApiRpcSyncer(
                        apiProvider,
                        connectionManager,
                        chain.syncInterval
                    )
