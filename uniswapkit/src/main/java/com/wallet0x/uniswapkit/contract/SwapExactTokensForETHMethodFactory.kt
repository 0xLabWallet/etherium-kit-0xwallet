...
object SwapExactTokensForETHMethodFactory : ContractMethodFactory {
    ...
    override val methodId = ContractMethodHelper.getMethodId(com.wallet0x.uniswapkit.contract.SwapExactTokensForETHMethod.Companion.methodSignature)
    ...
    override fun createMethod(inputArguments: ByteArray): ContractMethod {
        ...
        return com.wallet0x.uniswapkit.contract.SwapExactTokensForETHMethod(
            amountIn,
            amountOutMin,
            path,
            to,
