...
object SwapETHForExactTokensMethodFactory : ContractMethodFactory {
    ...
    override val methodId = ContractMethodHelper.getMethodId(com.wallet0x.uniswapkit.contract.SwapETHForExactTokensMethod.Companion.methodSignature)
    ...
    override fun createMethod(inputArguments: ByteArray): ContractMethod {
        ...
        return com.wallet0x.uniswapkit.contract.SwapETHForExactTokensMethod(
            amountOut,
            path,
            to,
            deadline
