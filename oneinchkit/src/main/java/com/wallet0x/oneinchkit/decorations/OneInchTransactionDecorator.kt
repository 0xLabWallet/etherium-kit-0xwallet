...
import com.wallet0x.oneinchkit.contracts.v4.SwapMethodV4
import com.wallet0x.oneinchkit.contracts.v4.UnoswapMethodV4
import com.wallet0x.oneinchkit.contracts.v4.UnparsedSwapMethodV4
import com.wallet0x.oneinchkit.contracts.v5.SwapMethodV5
import com.wallet0x.oneinchkit.contracts.v5.UnoswapMethodV5
import com.wallet0x.oneinchkit.contracts.v5.UnparsedSwapMethodV5
    ...
    override fun decoration(
        ...
        when (contractMethod) {
            ...
            is UnparsedSwapMethodV4, is UnparsedSwapMethodV5 -> {
                ...
                val incomingTokenAmount = getTokenAmount(eventInstances, true)?.let { com.wallet0x.oneinchkit.decorations.OneInchUnknownDecoration.TokenAmount(it.first, it.second) }
                val outgoingTokenAmount = getTokenAmount(eventInstances, false)?.let { com.wallet0x.oneinchkit.decorations.OneInchUnknownDecoration.TokenAmount(it.first, it.second) }

                when {
                    outgoingEth > BigInteger.ZERO -> {
                        tokenAmountIn = com.wallet0x.oneinchkit.decorations.OneInchUnknownDecoration.TokenAmount(OneInchDecoration.Token.EvmCoin, outgoingEth)
                        tokenAmountOut = incomingTokenAmount
                    }
                    outgoingEth < BigInteger.ZERO -> {
                        tokenAmountIn = outgoingTokenAmount
                        tokenAmountOut = com.wallet0x.oneinchkit.decorations.OneInchUnknownDecoration.TokenAmount(OneInchDecoration.Token.EvmCoin, outgoingEth)
                    }
                    else -> {
                        tokenAmountIn = outgoingTokenAmount
                        tokenAmountOut = incomingTokenAmount
                ...
                return com.wallet0x.oneinchkit.decorations.OneInchUnknownDecoration(
                    to,
                    tokenAmountIn,
                    tokenAmountOut
                )
