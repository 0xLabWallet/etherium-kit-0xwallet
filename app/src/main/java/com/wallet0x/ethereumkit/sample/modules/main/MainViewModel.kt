...
import com.wallet0x.ethereumkit.sample.core.EthereumAdapter
import com.wallet0x.ethereumkit.sample.core.TransactionRecord
...
import com.wallet0x.uniswapkit.models.TradeData
...
class MainViewModel : ViewModel() {
    ...
    lateinit var erc20Adapter: com.wallet0x.ethereumkit.sample.core.Erc20Adapter
    ...
    val sendStatus = com.wallet0x.ethereumkit.sample.SingleLiveEvent<Throwable?>()
    val estimatedGas = com.wallet0x.ethereumkit.sample.SingleLiveEvent<String>()
    ...
    val swapStatus = com.wallet0x.ethereumkit.sample.SingleLiveEvent<Throwable?>()

    val fromToken: Erc20Token = com.wallet0x.ethereumkit.sample.Configuration.erc20Tokens[0]
    val toToken: Erc20Token = com.wallet0x.ethereumkit.sample.Configuration.erc20Tokens[1]
    lateinit var gasPriceHelper: GasPriceHelper

    fun init() {
        val words = com.wallet0x.ethereumkit.sample.Configuration.defaultsWords.split(" ")
        val seed = Mnemonic().toSeed(words)
        signer = Signer.getInstance(seed, com.wallet0x.ethereumkit.sample.Configuration.chain)
        ethereumKit = createKit()
        ethereumAdapter = EthereumAdapter(ethereumKit, signer)
        erc20Adapter = com.wallet0x.ethereumkit.sample.core.Erc20Adapter(
            com.wallet0x.ethereumkit.sample.App.instance, fromToken ?: toToken
            ?: com.wallet0x.ethereumkit.sample.Configuration.erc20Tokens.first(), ethereumKit, signer
        )
    ...
    private fun createKit(): EthereumKit {
        ...
        when (com.wallet0x.ethereumkit.sample.Configuration.chain) {
            Chain.BinanceSmartChain -> {
                transactionSource = TransactionSource.bscscan(com.wallet0x.ethereumkit.sample.Configuration.bscScanKey)
                rpcSource = RpcSource.binanceSmartChainHttp()
            }
            Chain.Ethereum -> {
                transactionSource = TransactionSource.ethereumEtherscan(com.wallet0x.ethereumkit.sample.Configuration.etherscanKey)
                rpcSource = if (com.wallet0x.ethereumkit.sample.Configuration.webSocket)
                    RpcSource.ethereumInfuraWebSocket(com.wallet0x.ethereumkit.sample.Configuration.infuraProjectId, com.wallet0x.ethereumkit.sample.Configuration.infuraSecret)
                else
                    RpcSource.ethereumInfuraHttp(com.wallet0x.ethereumkit.sample.Configuration.infuraProjectId, com.wallet0x.ethereumkit.sample.Configuration.infuraSecret)
            }
            Chain.ArbitrumOne -> {
                transactionSource = TransactionSource.arbiscan(com.wallet0x.ethereumkit.sample.Configuration.arbiscanApiKey)
                rpcSource = RpcSource.arbitrumOneRpcHttp()
            }
            Chain.EthereumGoerli -> {
                transactionSource = TransactionSource.goerliEtherscan(com.wallet0x.ethereumkit.sample.Configuration.etherscanKey)
                rpcSource = if (com.wallet0x.ethereumkit.sample.Configuration.webSocket)
                    RpcSource.goerliInfuraWebSocket(com.wallet0x.ethereumkit.sample.Configuration.infuraProjectId, com.wallet0x.ethereumkit.sample.Configuration.infuraSecret)
                else
                    RpcSource.goerliInfuraHttp(com.wallet0x.ethereumkit.sample.Configuration.infuraProjectId, com.wallet0x.ethereumkit.sample.Configuration.infuraSecret)
            }
            else -> {
                rpcSource = null
        ...
        return if (com.wallet0x.ethereumkit.sample.Configuration.watchAddress != null) {
            EthereumKit.getInstance(
                com.wallet0x.ethereumkit.sample.App.instance,
                Address(com.wallet0x.ethereumkit.sample.Configuration.watchAddress),
                com.wallet0x.ethereumkit.sample.Configuration.chain, rpcSource, transactionSource,
                com.wallet0x.ethereumkit.sample.Configuration.walletId
            )
        } else {
            val words = com.wallet0x.ethereumkit.sample.Configuration.defaultsWords.split(" ")
            EthereumKit.getInstance(
                com.wallet0x.ethereumkit.sample.App.instance, words, "",
                com.wallet0x.ethereumkit.sample.Configuration.chain, rpcSource, transactionSource,
                com.wallet0x.ethereumkit.sample.Configuration.walletId
            )
        }
    ...
    fun clear() {
        EthereumKit.clear(com.wallet0x.ethereumkit.sample.App.instance, com.wallet0x.ethereumkit.sample.Configuration.chain, com.wallet0x.ethereumkit.sample.Configuration.walletId)
        Erc20Kit.clear(com.wallet0x.ethereumkit.sample.App.instance, com.wallet0x.ethereumkit.sample.Configuration.chain, com.wallet0x.ethereumkit.sample.Configuration.walletId)
        init()
    }
